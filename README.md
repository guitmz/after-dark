...
```shell
curl -s https://git.habd.as/comfusion/after-dark/raw/branch/master/bin/install | sh
```

Installation should complete in a matter of seconds, [even on Android](https://git.habd.as/comfusion/after-dark/src/branch/master/images/docs/feat-quick-installer.mp4). If running Windoze, get [`cmder`](https://github.com/cmderdev/cmder) before attempting to do anything useful.
