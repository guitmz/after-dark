...
<aside class="capabilities">
  ...
  <table>
    <legend>After Dark {{< external href="https://medium.com/@jhabdas/webpack-is-your-achilles-heel-d3cd80821a4f" text="ditches the bundler" />}} and through careful construction provides capabilities you won't find anywhere else:</legend>
    <tr>
