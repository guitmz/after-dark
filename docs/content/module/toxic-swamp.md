...
Follow the instructions in {{< external "https://git.habd.as/comfusion/webminerpool" />}} to create your own proxy. Reference the following table to understand when connections occur.
